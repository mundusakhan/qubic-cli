...
enum COMMAND
{
    ...
    QRWA_DONATE_TO_TREASURY_CMD,
    QRWA_VOTE_GOV_PARAMS_CMD,
    QRWA_CREATE_ASSET_RELEASE_POLL_CMD,
    QRWA_VOTE_ASSET_RELEASE_CMD,
    QRWA_DEPOSIT_GENERAL_ASSET_CMD,
    QRWA_REVOKE_ASSET_RIGHTS_CMD,
    QRWA_GET_GOV_PARAMS_CMD,
    QRWA_GET_GOV_POLL_CMD,
    QRWA_GET_ASSET_RELEASE_POLL_CMD,
    QRWA_GET_TREASURY_BALANCE_CMD,
    QRWA_GET_DIVIDEND_BALANCES_CMD,
    QRWA_GET_TOTAL_DISTRIBUTED_CMD,
    QRWA_GET_ACTIVE_ASSET_RELEASE_POLL_IDS_CMD,
    QRWA_GET_ACTIVE_GOV_POLL_IDS_CMD,
    QRWA_GET_GENERAL_ASSET_BALANCE_CMD,
    QRWA_GET_GENERAL_ASSETS_CMD,
